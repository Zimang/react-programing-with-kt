...
fun IO.buildPluginAccessorsFor(
    ...
    val header = writeFileFacadeClassHeader {
        accessorList.forEach { accessor ->
            ...
            val getterSignature =
                jvmGetterSignatureFor(propertyName, "(L${receiverType.internalName};)L${returnType.internalName};")
            writePropertyOf(
...
fun pluginAccessorsFor(
    ...
    extendedType: TypeSpec = pluginDependenciesSpecTypeSpec
): Sequence<PluginAccessor> = sequence {
