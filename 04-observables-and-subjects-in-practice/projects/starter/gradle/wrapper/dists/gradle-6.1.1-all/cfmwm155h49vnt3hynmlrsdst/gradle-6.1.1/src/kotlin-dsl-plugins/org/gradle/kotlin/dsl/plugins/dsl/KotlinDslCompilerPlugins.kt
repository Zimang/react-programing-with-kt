...
fun KotlinCompile.applyExperimentalWarning(experimentalWarning: Boolean) {
    replaceLoggerWith(
        if (experimentalWarning) KotlinCompilerWarningSubstitutingLogger(
...
class KotlinCompilerWarningSubstitutingLogger(
    ...
    override fun warn(message: String) {
        if (message.contains(KotlinCompilerArguments.samConversionForKotlinFunctions)) delegate.warn(
            kotlinDslPluginExperimentalWarning(target, link)
        )
