...
fun ParameterNamesSupplier.parameterNamesFor(
    typeName: String,
    functionName: String,
...
private
fun ApiTypeProvider.Context.apiFunctionParametersFor(
    function: ApiFunction,
    delegate: MethodNode,
    visitedSignature: MethodSignatureVisitor?
) =
    delegate.visibleParameterAnnotations?.map { it.has<Nullable>() }.let { parametersNullability ->
        val parameterTypesBinaryNames =
